...
The lymphatic system is part of the body’s immune system and consists of various organs and tissues, including the lymph nodes, spleen, thymus gland, and bone marrow. **Lymphocytes** are a type of white blood cell that helps the body fight disease. **Lymphoma** develops when these cells acquire genetic mutations that cause them to grow and divide uncontrollably, potentially accumulating within lymphatic organs and tissues. People affected by lymphoma may experience symptoms such as fatigue, unexplained weight loss, swollen lymph nodes, fever, and night sweats. The disease and its treatment can also weaken the immune system, increasing susceptibility to infections.

A [microarray](https://www.nature.com/scitable/definition/microarray-202/)  is a physical surface containing thousands of short DNA segments, known as probes, arranged at predefined locations. Messenger RNA extracted from a follicular or diffuse lymphoma sample is converted into complementary DNA, or cDNA, and labeled with a fluorescent dye. The labeled cDNA binds, or hybridizes, to probes with complementary sequences on the microarray. This binding indicates that the corresponding genes were expressed in the original sample. The strength of the fluorescence signal at each probe location reflects the relative abundance of the corresponding mRNA and, therefore, the relative expression level of that gene. By comparing these expression patterns across samples, researchers can identify genes that may distinguish lymphoma subtypes or be associated with clinically relevant characteristics.
...
![Dataset 2 Principal Components](/img/project-images/lymphoma-microarray-clustering/dataset-2-principal-components.webp)
![Dataset 3 Principal Components](/img/project-images/lymphoma-microarray-clustering/dataset-3-principal-components.webp)
...
![Outliers](/img/project-images/lymphoma-microarray-clustering/outliers.webp)
...
![minimize loss function](/img/project-images/lymphoma-microarray-clustering/minimize-loss-function.webp)
...
![K-means Model, No Outliers](/img/project-images/lymphoma-microarray-clustering/k-means-model-no-outliers.webp)
